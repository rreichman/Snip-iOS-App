...
class ConfirmationPresentationDelegate : NSObject, UIViewControllerTransitioningDelegate {
    
    
    func presentationController(forPresented presented: UIViewController, presenting: UIViewController?, source: UIViewController) -> UIPresentationController? {
        return ConfirmationPresentationController(presentedViewController:presented, presenting: presenting)
    }
...
extension ConfirmationPresentationController: UIViewControllerAnimatedTransitioning {
