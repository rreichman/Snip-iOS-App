...
struct NetworkSettings {
    static let main_net: NetworkSettings = NetworkSettings("https://api.etherscan.io", "0x44F588aEeB8C44471439D1270B3603c66a9262F1", 1)
    static let rinkeby: NetworkSettings = NetworkSettings("https://api-rinkeby.etherscan.io", "0x2b8808a54fd3c55e01d3b95b6f1a0eaab3f952cc", 4)
    ...
    let chain_id: Int
    init(_ eth: String, _ contract: String, _ chain: Int) {
